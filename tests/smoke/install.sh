...
assert_json "$config" "data['custom'] is True and data['mcp']['servers']['user_server']['url'] == 'https://example.invalid/mcp' and data['mcp']['servers']['context7']['type'] == 'remote' and data['experimental']['subagent_depth'] == 1"
