...
description: >
  ...
  confirms root cause, then fixes minimally and verifies. When the issue
  is not yet a confirmed product bug, it should hand off cleanly instead
  of guessing. Unlike b-test, b-debug owns runtime behavior failures, not
  test-mechanic issues such as wrong assertions, mocks, or fixtures.
