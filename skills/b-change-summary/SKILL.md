...
description: >
  Analyze staged and branch changes and write a concise Conventional
  Commits message, PR title, and structured PR description for one
  cohesive change.
argument-hint: "[change-context] [base-branch]"
---
