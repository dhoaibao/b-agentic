...
Read `{{runtime_reference_root}}/contract/06-safety.md` before using `apply_patch` for imports, config, prose, or non-symbol glue under the global patch discipline.
