...
If the user provides a URL/file/document, classify it as public URL, internal/private URL, local plain text, local rich document, or likely internal document. Read `../../b-agentic/references/contract/safety-tools.md` before external extraction of internal/private URLs, rich documents, or likely internal documents unless already approved.
