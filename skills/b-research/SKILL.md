...
Use `firecrawl-extended` only for maps or structured fields. Read `../../b-agentic/references/contract/04-tool-model.md` and `../../b-agentic/references/contract/06-safety.md` before using `firecrawl-deep` or applying public-web privacy gates.
