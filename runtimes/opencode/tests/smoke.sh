...
run_runtime_smoke_cases() {
  ...
  assert_contains "$sandbox_opencode_install_report/install.log" 'hooks: strict enforcement ON by default; use --advisory or set B_AGENTIC_ADVISORY=1 to opt out'
