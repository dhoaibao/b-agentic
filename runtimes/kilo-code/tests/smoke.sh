...
run_runtime_smoke_cases() {
  ...
  local sandbox="$WORK_DIR/kilo-code"
  ...
  assert_no_path "$sandbox/home/.config/kilo/commands/b-plan.md"
  ...
  assert_file "$sandbox/home/.kilo/b-agentic/tooling/install/jsonc.py"
