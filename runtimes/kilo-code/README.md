...
- `scripts/install.sh` — Thin runtime driver sourced by `install.sh`. Handles kernel install, skills sync, MCP config merge, and cleanup of previously managed profiles.
...
- **Subagent profiles:** Deferred; not installed by default.
