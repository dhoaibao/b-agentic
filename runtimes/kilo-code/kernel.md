...
# b-agentic - Agent Workflow Kernel for Kilo Code
...
Installed detailed refs live under `~/.config/kilo/b-agentic/references/contract/`. They are intentionally few:
...
For overlaps, read `~/.config/kilo/b-agentic/references/contract/runtime.md`.
