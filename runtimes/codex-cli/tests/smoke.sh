...
run_runtime_smoke_cases() {
  ...
  assert_contains "$sandbox_codex_install_report/install.log" 'hooks: runtime conformance hooks warn by default; use --strict or set B_AGENTIC_STRICT=1 to request blocking'
