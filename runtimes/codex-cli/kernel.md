...
Decision cards live under `~/.codex/b-agentic/references/cards/*.md`. Use them as the short point-of-use path, then fall back to the detailed contract section when a card does not settle the question.
