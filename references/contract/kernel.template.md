...
Decision cards live under `{{runtime_metadata_root}}/references/cards/*.md`. Use them as the short point-of-use path, then fall back to the detailed contract section when a card does not settle the question.
